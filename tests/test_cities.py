...
def test_list_cities_with_unknown_projects_filter():
...
def test_get_city_by_city_id_with_unknown_city_id():
...
def test_get_city_indicators_with_unknown_city_id_and_admin_level():
...
def test_get_city_geometry_with_unknown_city_id_and_admin_level():
    response = client.get(
