...
def test_list_indicators_no_filter():
...
def test_get_cities_by_indicator_id():
    ...
    try:
        ...
        pytest.fail(f"Response did not match CitiesByIndicatorIdResponse model: {e}")
...
def test_get_metadata_by_indicator_id():
    ...
    try:
        ...
        pytest.fail(f"Response did not match MetadataByIndicatorIdResponse model: {e}")
